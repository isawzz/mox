...
async function start() { }//libsAll(96);}//mlib_vio();}//splitClosureVio(); } //project_ilms(); }//return;mlib_p5();return;project_p5(); }

async function libsAll(num = 96) {
	codeAllInOne(`../vio${num}`, ['codebig', 'eliminated', 'experimental', 'coderest', 'closure', 'done', 'bau1', 'bau2', 'bau3', 'bau4']);
}
