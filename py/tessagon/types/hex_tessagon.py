...
class HexTile(Tile):
    ...
    def init_verts(self):
        return {
            "top": {"left": None, "center": None, "right": None},
    ...
    def color_pattern2(self):
        if self.fingerprint[0] % 3 == 0:
            ...
            self.color_paths_hash(
                {1: [["middle"]], 2: [["top", "left"], ["bottom", "left"]]}, 0
            )
        else:
            self.color_paths_hash(
                {2: [["middle"]], 1: [["top", "right"], ["bottom", "right"]]}, 0
            )
